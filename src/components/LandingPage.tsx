    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-6 sm:px-8 lg:px-12 py-24 sm:py-32 md:py-40 lg:py-48">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20 sm:mb-24 md:mb-28 lg:mb-32">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">{t('expertise.title')}</h2>
            <p className="text-lg sm:text-xl text-gray-400">{t('expertise.subtitle')}</p>
          </div>
      ...
      <section className="px-6 sm:px-8 lg:px-12 py-24 sm:py-32 md:py-40 lg:py-48 bg-gray-900/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20 sm:mb-24 md:mb-32 lg:mb-36">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">{t('howItWorks.title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-20 lg:gap-28">
            <div className="text-center space-y-7 group">
              ...
              <h3 className="font-semibold text-2xl group-hover:text-indigo-400 transition-colors">{t('howItWorks.step1')}</h3>
            ...
            <div className="text-center space-y-7 group">
              ...
              <h3 className="font-semibold text-2xl group-hover:text-indigo-400 transition-colors">{t('howItWorks.step2')}</h3>
              <p className="text-gray-400 leading-relaxed text-lg">
            ...
            <div className="text-center space-y-7 group">
              ...
              <h3 className="font-semibold text-2xl group-hover:text-indigo-400 transition-colors">{t('howItWorks.step3')}</h3>
              <p className="text-gray-400 leading-relaxed text-lg">
      ...
      <section className="px-6 sm:px-8 lg:px-12 py-24 sm:py-32 md:py-40 lg:py-48">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-20 sm:mb-24 gap-6">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-5">{t('projects.title')}</h2>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {project.verified && (
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <span className="text-xs text-green-500">{t('projects.verified')}</span>
                      </div>
                    )}
                  </div>
                </div>
      ...
      <section className="px-6 sm:px-8 lg:px-12 py-24 sm:py-32 md:py-40 lg:py-48 bg-gray-900/20">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-20 sm:mb-24 gap-6">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-5">{t('experts.title')}</h2>
              <p className="text-lg text-gray-400">{t('experts.subtitle')}</p>
            </div>
            <button className="hidden sm:flex items-center gap-2 text-gray-400 hover:text-white hover:gap-3 transition-all">
              {t('projects.viewAll')}
              <ArrowRight className="w-5 h-5" />
